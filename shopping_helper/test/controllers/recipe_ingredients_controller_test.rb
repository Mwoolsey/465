...
class RecipeIngredientsControllerTest < ActionController::TestCase
  ...
  test "should create recipe_ingredient" do
    assert_difference('RecipeIngredient.count') do
      post :create, recipe_ingredient: { ingredient_id: @recipe_ingredient.ingredient_id, recipe_id: @recipe_ingredient.recipe_id }
    end
  ...
  test "should update recipe_ingredient" do
    patch :update, id: @recipe_ingredient, recipe_ingredient: { ingredient_id: @recipe_ingredient.ingredient_id, recipe_id: @recipe_ingredient.recipe_id }
    assert_redirected_to recipe_ingredient_path(assigns(:recipe_ingredient))
  end
